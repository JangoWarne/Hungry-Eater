...
/**
 * This class is the main class to simulate an entire population of creatures
 * it runs its code in a separate processor thread
 *
...
public class Simulation {
    ...
    public void startSimulation( SimulationController uiReference, Status status ) {
        ...
        // Display best of most recent generation on UI
